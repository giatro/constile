...
<head>
<title>.ConStile | Risultati della ricerca</title>
...
<div class="nascosto">[<a name="TOP" id="TOP" href="ricerca.php#MENU">Vai al menu di navigazione principale</a>]</div>
<!-- /logo -->
<hr />
...
<h2 class="nascosto">Sezioni</h2>
	<ul>
		<li class="nascosto">[<a name="MENU" id="MENU" href="ricerca.php#CONTENUTI">Vai ai contenuti</a>]</li>
...
<hr />
<div id="bodycontent">
<div class="nascosto">[<a name="CONTENUTI" id="CONTENUTI" href="ricerca.php#PIEDE">Vai al pi&egrave; di pagina</a>]</div>
<div id="contenuto">
<h1>Ricerca nell'archivio:</h1>
...
<p class="nascosto"><a accesskey="T" name="PIEDE" id="PIEDE" href="ricerca.php#TOP" title="Torna all'inizio della pagina">Torna all'inizio della pagina</a></p>
...
<div id="page-url">l'indirizzo di questa pagina &egrave;: http://www.constile.org/ricerca.php</div>
